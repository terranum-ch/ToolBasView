...
ADDSPATIALDATA_DLG::ADDSPATIALDATA_DLG(wxWindow* parent, DataBase* pDatabase, wxWindowID id, const wxString& caption,
...
bool ADDSPATIALDATA_DLG::Create(wxWindow* parent, DataBase* pDatabase, wxWindowID id, const wxString& caption,
                                const wxPoint& pos, const wxSize& size, long style) {
  SetDataBase(pDatabase);
...
bool ADDSPATIALDATA_DLG::AddListOfTable() {
  ...
  if (m_pDatabase != NULL) {
    ...
    if (m_pDatabase->DataBaseGetResults(myListTables) == false) return false;
...
void ADDSPATIALDATA_DLG::CreateControls() {
  ...
  wxStaticText* itemStaticText18 = new wxStaticText(
      itemDialog1, wxID_STATIC, _("Support importing all spatial data types (POINTS | LINES | POLYGONS)"),
  ...
  wxStaticText* itemStaticText4 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Spatial data source :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer3->Add(itemStaticText4, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  m_DLGAS_FileSelector = new wxFilePickerCtrl(itemDialog1, ID_FILESELECTOR, wxEmptyString, _("Select a shapefile"),
                                              _("ESRI's shapefile (*.shp)|*.shp"), wxDefaultPosition, wxDefaultSize);
  itemFlexGridSizer3->Add(m_DLGAS_FileSelector, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText6 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Destination table :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_DLGAS_ListTables =
      new wxChoice(itemDialog1, ID_LISTTABLES, wxDefaultPosition, wxSize(400, -1), m_DLGAS_ListTablesStrings, 0);
  itemFlexGridSizer3->Add(m_DLGAS_ListTables, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  itemBoxSizer2->Add(5, 5, 1, wxGROW | wxALL, 5);

  m_DLGAS_Chk_Index =
      new wxCheckBox(itemDialog1, ID_CHECKBOX, _("Compute spatial index"), wxDefaultPosition, wxDefaultSize, 0);
  m_DLGAS_Chk_Index->SetValue(true);
  itemBoxSizer2->Add(m_DLGAS_Chk_Index, 0, wxALIGN_LEFT | wxALL, 5);

  wxStaticLine* itemStaticLine9 =
      new wxStaticLine(itemDialog1, ID_STATICLINE, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL);
