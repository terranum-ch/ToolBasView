...
bool SEARCHSPATIALPOINT_DLG::IsControlFilled() {
  if (!m_DLGSS_coord_x->IsEmpty() && !m_DLGSS_coord_y->IsEmpty()) return TRUE;
...
SEARCHSPATIALPOINT_DLG::SEARCHSPATIALPOINT_DLG(wxWindow* parent, DataBase* database, wxWindowID id,
...
bool SEARCHSPATIALPOINT_DLG::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
SEARCHSPATIALPOINT_DLG::~SEARCHSPATIALPOINT_DLG() {
  if (m_GISDB.GISIsOpened()) m_GISDB.GISClose();
}
...
void SEARCHSPATIALPOINT_DLG::CreateControls() {
  ...
  wxStaticText* itemStaticText6 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("X min :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer5->Add(itemStaticText6, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  m_DLGSS_Map_Xmin =
      new wxStaticText(itemDialog1, wxID_STATIC, _T(""), wxDefaultPosition, wxSize(120, -1), wxALIGN_RIGHT);
  itemFlexGridSizer5->Add(m_DLGSS_Map_Xmin, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText8 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("X max :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer5->Add(itemStaticText8, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  m_DLGSS_Map_Xmax =
      new wxStaticText(itemDialog1, wxID_STATIC, _T(""), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
  ...
  wxStaticText* itemStaticText12 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Y min :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText14 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Y max :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText18 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("x :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText20 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("y :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText23 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Buffer size [m] :"), wxDefaultPosition, wxDefaultSize, 0);
  itemBoxSizer22->Add(itemStaticText23, 0, wxALIGN_TOP | wxALL, 5);

  m_DLGSS_buffer = new wxSlider(itemDialog1, ID_SLIDER1, 0, 0, 100, wxDefaultPosition, wxDefaultSize,
  ...
  wxStaticText* itemStaticText30 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Status :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_DLGSS_result_status_tm =
      new wxStaticText(itemDialog1, wxID_STATIC, _T("[ms]"), wxDefaultPosition, wxDefaultSize, 0);
