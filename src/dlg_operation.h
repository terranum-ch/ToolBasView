...
class SQLPROCESS_DLG_OP2 : public wxDialog {
 ...
 public:
  ...
  SQLPROCESS_DLG_OP2(wxWindow *parent, DataBase *database, wxWindowID id = wxID_ANY,
                     const wxString &title = _("Run SQL code"), const wxPoint &pos = wxDefaultPosition,
...
class SHOWRESULT_OP2 : public wxDialog {
 ...
 public:
  // constructors and destructors
  SHOWRESULT_OP2(wxWindow *parent, DataBase *database, wxWindowID id = wxID_ANY,
                 const wxString &title = _("SQL Results"), const wxPoint &pos = wxDefaultPosition,
                 const wxSize &size = wxSize(500, 500), long style = wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER);
...
class NEWDBASE_OP2 : public wxDialog {
 public:
  // constructors and destructors
  NEWDBASE_OP2(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos = wxDefaultPosition,
