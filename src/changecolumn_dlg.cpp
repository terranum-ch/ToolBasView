...
ChangeColumn_DLG::ChangeColumn_DLG(wxWindow* parent, DataBase* database, const wxString& tablename, wxWindowID id,
  ...
  m_BtnCtrlApply->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ChangeColumn_DLG::OnApplyButton), NULL,
                          this);
...
ChangeColumn_DLG::~ChangeColumn_DLG() {
  m_BtnCtrlApply->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ChangeColumn_DLG::OnApplyButton), NULL,
                             this);
  m_BtnCtrlOK->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(ChangeColumn_DLG::OnOkButton), NULL,
                          this);
}
...
void ChangeColumn_DLG::_DoApplyChange() {
  ...
  wxString myQuery =
      wxString::Format(_T("ALTER TABLE `%s` MODIFY COLUMN `%s` %s;"), m_TableName, myColName, myChangeTxt);
...
void ChangeColumn_DLG::_CreateControls() {
  ...
  m_TypeCtrl = new wxRadioBox(this, wxID_ANY, _("New Type"), wxDefaultPosition, wxDefaultSize,
                              sizeof(m_FieldTypes) / sizeof(wxString), m_FieldTypes, 1, wxRA_SPECIFY_COLS);
  ...
  m_ResultCtrl =
      new wxStaticText(this, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_VERTICAL | wxALIGN_LEFT);
  m_ResultCtrl->Wrap(-1);
