...
@SET PARAMGEOS=D:\LIB\geos-3.3.2
...
msbuild ToolBasView.sln /property:Configuration=Release
echo %ERRORLEVEL%
IF ERRORLEVEL 1 goto QuitErrorBuildScript
