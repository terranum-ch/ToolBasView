...
IF (SEARCH_GEOS)
	...
	IF (WIN32)
		...
		FIND_PATH(GEOS_INCLUDE_DIR2  geos.h
			${SEARCH_GEOS_LIB_PATH}/source
			${SEARCH_GEOS_LIB_PATH}/include
			)
  		
  		FIND_LIBRARY(GEOS_LIBRARIES
	  		geos_c_i
	  		PATH ${SEARCH_GEOS_LIB_PATH}/source	
  ...
  ## IF GEOS PARAMETERS ARE DEFINED, USE THEM
   IF(GEOS_INCLUDE_DIR)
    ...
    INCLUDE_DIRECTORIES(${GEOS_INCLUDE_DIR2})
    MESSAGE ("DBG : GEOS include is ${GEOS_INCLUDE_DIR}, ${GEOS_INCLUDE_DIR2}")
