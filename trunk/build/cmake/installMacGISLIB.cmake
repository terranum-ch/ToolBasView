...
IF (SEARCH_CURL_LIB_PATH)
  SET (CURL_LIBRARIES_PATH "${SEARCH_CURL_LIB_PATH}/lib")
ELSE (SEARCH_CURL_LIB_PATH)
  ...
  IF ("/usr/lib" STREQUAL CURL_LIBRARIES_PATH)
    SET (CURL_LIBRARIES_PATH OFF)
  ENDIF ()
  ENDIF(CURL_LIBRARIES)
ENDIF (SEARCH_CURL_LIB_PATH)


IF(CURL_LIBRARIES_PATH)
  MESSAGE (STATUS "Installing CURL libraries from ${CURL_LIBRARIES_PATH}")
  ADD_CUSTOM_COMMAND( TARGET ${CMAKE_PROJECT_NAME} POST_BUILD
    COMMAND mkdir -p 	${BUNDLELIBPATH}
