...
public:
    DELETETABLEDATA_DLG();
    DELETETABLEDATA_DLG( wxWindow* parent, wxWindowID id = SYMBOL_DELETETABLEDATA_DLG_IDNAME,
	...
	void SetActiveFlags(int iFlags){ m_DlgFlags = iFlags;}
	int GetSelectedFlags(){ return m_DlgFlags;}
